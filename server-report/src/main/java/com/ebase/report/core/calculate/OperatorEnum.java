...
public enum OperatorEnum {
    ...
    OperatorEnum(String expression, int paramNumber, int priority, String desc) {
    ...
    public static OperatorEnum getByExpression(String expression) {
